...
interface Props {
  ...
  // the room grid instead of blocking the whole form on this data.
...
export function HotelReservationForm({ tables, zones, tablesLoading = false, restaurantId, initialData, preSelectedTableId, businessType }: Props) {
