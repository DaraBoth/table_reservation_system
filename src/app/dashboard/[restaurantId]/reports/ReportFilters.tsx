...
export function ReportFilters() {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between bg-card/50 backdrop-blur-xl border border-border/60 p-2 rounded-2xl shadow-xl relative overflow-hidden">
        {/* Weekly Navigation */}
        <div className="flex items-center gap-1 w-full">
          <Button
            ...
            className="h-10 w-10 text-muted-foreground hover:text-foreground hover:bg-muted/50 rounded-xl transition-all"
          >
