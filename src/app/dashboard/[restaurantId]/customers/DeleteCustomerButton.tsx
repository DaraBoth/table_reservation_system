  ...
  return (
    <form action={action}>
      ...
      <button
        ...
        disabled={pending}
        onClick={(e) => {
          if (!confirm(t('dashboard.removeFromSavedListQuestion', { defaultValue: 'Remove "{{name}}" from the saved list?', name }))) e.preventDefault()
        }}
        ...
        title={t('dashboard.removeFromSavedList', { defaultValue: 'Remove from saved list' })}
      >
